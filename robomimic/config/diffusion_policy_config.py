...
class DiffusionPolicyConfig(BaseConfig):
    ...
    def algo_config(self):
        ...
        # Transformer parameters (alternative to UNet; set unet.enabled=False to use)
        self.algo.transformer.enabled = False
        self.algo.transformer.embed_dim = 256        # model / embedding dimension
        self.algo.transformer.num_layers = 4         # number of transformer encoder layers
        self.algo.transformer.num_heads = 4          # number of attention heads
        self.algo.transformer.emb_dropout = 0.1      # dropout on input embeddings
        self.algo.transformer.attn_dropout = 0.1     # dropout inside transformer layers
