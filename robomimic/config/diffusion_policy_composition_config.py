"""
Config for Diffusion Policy Composition algorithm.
"""

from robomimic.config.base_config import BaseConfig

class DiffusionPolicyCompositionConfig(BaseConfig):
    ALGO_NAME = "diffusion_policy_composition"
    ...
    def train_config(self):
        ...
        """
        super(DiffusionPolicyCompositionConfig, self).train_config()
